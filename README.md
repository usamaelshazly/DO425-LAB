...
`pandoc -f markdown_github --listings -H listings-setup.tex -V geometry:margin=0.3in -o DO425.pdf DO425.md`# Red Hat Security: Securing Containers & OpenShift (DO425)
